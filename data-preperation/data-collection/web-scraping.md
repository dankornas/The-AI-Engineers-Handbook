...
```python
# Print the text contained within each p element
for p in p_elements:
    print(p.text)
...
Here is a simple example of web scraping using Python and the BeautifulSoup library:
...
This code makes a request to the specified Wikipedia page, parses the HTML using BeautifulSoup, and then prints the title and first paragraph of the page.
